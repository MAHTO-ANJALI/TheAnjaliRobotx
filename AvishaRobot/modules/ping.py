...
from AvishaRobot import StartTime, dispatcher
from AvishaRobot.modules.disable import DisableAbleCommandHandler
from AvishaRobot.modules.helper_funcs.chat_status import sudo_plus
...
def ping(update: Update, context: CallbackContext):
    ...
    message.edit_text(
        "❖ 🫧⏤͟͟͞ـﮩ♡︎ ˹ꫝɴᴊᴧʟɪ ꝛᴏʙᴏᴛ˼ [🇮🇳] ɪs ᴀʟɪᴠᴇ ʙᴀʙʏ ♥︎\n\n"
        "● <b>ᴛɪᴍᴇ ᴛᴀᴋᴇɴ ➥</b> <code>{}</code>\n"
        "● <b>ᴜᴘᴛɪᴍᴇ ➥</b> <code>{}</code>\n\n"
        "❖ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ➥ 🫧⏤͟͟͞ـﮩ♡︎ ˹Ҩ፝֟፝ͷ ꫝɴᴊᴀʟɪ˼ [🇮🇳]".format(telegram_ping, uptime),
